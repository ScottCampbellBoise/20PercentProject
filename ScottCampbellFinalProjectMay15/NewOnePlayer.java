...
public class NewOnePlayer extends JPanel implements ActionListener, KeyListener
{
    ...
    public NewOnePlayer(int difficulty, Color gameColor, String playerName) {
    ...
    public NewOnePlayer(int difficulty, BufferedImage gameImage, String playerName){
        //listen to key presses
        setFocusable(true);
        addKeyListener(this);
        //call step() 60 fps
    ...
    public void updateScore(){
        ...
        p1Score.setText(playerName+" Score: "+playerOneScore);
        this.add(p1Score);
        ...
        p1Games.setText(playerName+" Games: "+playerOneGames);
        this.add(p1Games);
